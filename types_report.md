...
Generated: 2025-08-25 17:36:49 UTC
...
one: {0 ↦ {{[0,1] ⊓ one.0}}}
two: {0 ↦ {{[0,1] ⊓ one.0}}}
maybe: {0 ↦ {{[2,1] ⊓ maybe.0 ⊓ none.0} ⊔ {[2,1] ⊓ maybe.0 ⊓ some.0}}, 1 ↦ {{[2,1] ⊓ maybe.1 ⊓ none.0} ⊔ {[2,1] ⊓ maybe.1 ⊓ some.0} ⊔ {[2,1] ⊓ maybe.1 ⊓ some.1}}}
wrap: {0 ↦ ⊥, 1 ↦ {{[1,0] ⊓ wrap.1}}}
wrap2: {0 ↦ {{[2,1] ⊓ wrap2.0}}, 1 ↦ {{[2,1] ⊓ wrap2.1}}}
pairish: {0 ↦ ⊥, 1 ↦ {{[1,0] ⊓ pairish.1}}, 2 ↦ {{[1,0] ⊓ pairish.2}}}
treeA: {0 ↦ {{[2,1] ⊓ leaf.0 ⊓ treeA.0} ⊔ {[2,1] ⊓ node.0 ⊓ treeA.0} ⊔ {[2,1] ⊓ node.2 ⊓ treeA.0}}, 1 ↦ {{[2,1] ⊓ leaf.0 ⊓ treeA.1} ⊔ {[2,1] ⊓ node.0 ⊓ treeA.1} ⊔ {[2,1] ⊓ node.1 ⊓ treeA.1} ⊔ {[2,1] ⊓ node.2 ⊓ treeA.1}}}
...
foo1: {0 ↦ {{[2,1] ⊓ t1.0} ⊔ {[2,1] ⊓ t2.0}}, 1 ↦ {{[2,1] ⊓ t1.1 ⊓ t2.1}}}
foo2: {0 ↦ {{[2,1] ⊓ t1.0} ⊔ {[2,1] ⊓ t2.0}}, 1 ↦ {{[2,1] ⊓ t1.1 ⊓ t2.1}}}
bar: {0 ↦ {{[2,1] ⊓ t1.0} ⊔ {[2,1] ⊓ t2.0}}, 1 ↦ {{[2,1]}}}
```
...
node: {0 ↦ {{[2,1] ⊓ node.0}}, 1 ↦ {{[2,1] ⊓ node.1}}, 2 ↦ {{[2,1] ⊓ node.2}}}
btree: {0 ↦ {{[2,1] ⊓ leaf.0} ⊔ {[2,1] ⊓ node.0}}, 1 ↦ {{[2,1] ⊓ leaf.1}}}
```
...
DUP: {0 ↦ {{[1,1]}}, 1 ↦ {{[2,0]}}}
SW: {0 ↦ {{[1,1] ⊓ SW.0}}, 1 ↦ {{[1,1] ⊓ SW.1}}, 2 ↦ {{[1,1] ⊓ SW.2}}}
ND1: {0 ↦ {{[0,1] ⊓ A.1 ⊓ C.1 ⊓ D.0 ⊓ E.0 ⊓ ND1.0}}, 1 ↦ {{[2,1] ⊓ ND1.1}}}
ND2: {0 ↦ {{[0,1] ⊓ A.1 ⊓ D.0 ⊓ E.0 ⊓ ND2.0}}, 1 ↦ {{[0,1] ⊓ A.1 ⊓ D.0 ⊓ E.0 ⊓ ND2.1} ⊔ {[0,1] ⊓ A.1 ⊓ D.1 ⊓ E.2 ⊓ ND2.1}}}
ND3: {0 ↦ {{[0,1] ⊓ ND3.0 ⊓ X2.0}}, 1 ↦ {{[0,1] ⊓ A.1 ⊓ B.1 ⊓ C.1 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1} ⊔ {[0,1] ⊓ A.1 ⊓ C.1 ⊓ ND3.1 ⊓ X2.1} ⊔ {[0,1] ⊓ ND3.1 ⊓ X2.0}}, 2 ↦ {{[0,1] ⊓ ND3.2 ⊓ X2.0}}}
CN1: {0 ↦ {{[1,1]}}, 1 ↦ {{[1,0] ⊓ D.1} ⊔ {[2,0] ⊓ A.1 ⊓ C.1}}}
CN2: {0 ↦ {{[0,1]}}, 1 ↦ {{[2,1] ⊓ A.1}}, 2 ↦ {{[0,1] ⊓ A.1 ⊓ B.1 ⊓ C.1}}}
...
AnnNest: {0 ↦ ⊥, 1 ↦ {{[1,1] ⊓ AnnNest.1}}}
RecNest1: {0 ↦ {{[0,1] ⊓ RecNest1.0 ⊓ RecNest2.0}}, 1 ↦ {{[2,1] ⊓ RecNest1.1}}}
...
PRE: {0 ↦ {{[0,1] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.0} ⊔ {[0,1] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.1}}, 1 ↦ {{[2,1] ⊓ PRE.1}}}
PRC: {0 ↦ ⊥, 1 ↦ {{[0,1] ⊓ PRC.1}}}
PRD: {0 ↦ ⊥, 1 ↦ {{[0,1] ⊓ PRC.1 ⊓ PRD.1}}}
PCX: {0 ↦ ⊥, 1 ↦ {{[1,0]}}}
PCY: {0 ↦ ⊥, 1 ↦ {{[2,1]}}}
PCZ: {0 ↦ ⊥, 1 ↦ {{[2,1]}}}
PRG: {0 ↦ ⊥, 1 ↦ {{[2,1] ⊓ PRG.1}}, 2 ↦ ⊥}
PRH: {0 ↦ {{[0,1] ⊓ PRG.1 ⊓ PRH.0}}, 1 ↦ {{[0,1] ⊓ PRG.1 ⊓ PRH.1}}, 2 ↦ {{[2,1] ⊓ PRH.2}}}
CA: {0 ↦ {{[0,1] ⊓ CA.0}}, 1 ↦ {{[2,1] ⊓ CA.1}}}
CC: {0 ↦ {{[0,1] ⊓ CA.0}}, 1 ↦ {{[1,0]} ⊔ {[2,1] ⊓ CA.1}}}
CA2: {0 ↦ {{[1,0] ⊓ CA2.0}}, 1 ↦ {{[1,1] ⊓ CA2.1}}, 2 ↦ {{[1,0] ⊓ CA2.1 ⊓ CA2.2}}}
CC2: {0 ↦ {{[1,0] ⊓ CA2.0}}, 1 ↦ {{[1,1] ⊓ CA2.1}}, 2 ↦ {{[1,0]}}}
CA0: {0 ↦ {{[0,1] ⊓ CA0.0}}}
CC0: {0 ↦ {{[0,1] ⊓ CA0.0}}}
CAX: {0 ↦ {{[1,0] ⊓ CAX.0 ⊓ CCX.0} ⊔ {[1,0] ⊓ CAX.0 ⊓ CCX.1}}, 1 ↦ {{[2,1] ⊓ CAX.1}}}
CBX: {0 ↦ {{[1,0] ⊓ CAX.0 ⊓ CCX.0} ⊔ {[1,0] ⊓ CAX.0 ⊓ CCX.1}}, 1 ↦ {{[2,1]}}}
CCX: {0 ↦ {{[1,0] ⊓ CAX.0 ⊓ CCX.0}}, 1 ↦ {{[1,0] ⊓ CAX.0 ⊓ CCX.1} ⊔ {[1,0] ⊓ CAX.1 ⊓ CCX.1}}}
```
...
H: {0 ↦ {{[0,1] ⊓ F.0 ⊓ H.0}}, 1 ↦ {{[2,1] ⊓ H.1}}}
F: {0 ↦ {{[0,1] ⊓ F.0 ⊓ H.0}}, 1 ↦ {{[0,1] ⊓ F.1 ⊓ H.1}}}
H2: {0 ↦ {{[0,1] ⊓ F2.0 ⊓ H2.0}}, 1 ↦ {{[2,1] ⊓ H2.1}}, 2 ↦ {{[0,1] ⊓ F2.1 ⊓ H2.1 ⊓ H2.2}}}
...
Y: {0 ↦ {{[0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.0} ⊔ {[1,0] ⊓ X.0 ⊓ Y.0}}, 1 ↦ {{[2,1] ⊓ Y.1}}}
Z: {0 ↦ {{[0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.0}}, 1 ↦ {{[0,1] ⊓ Y.1 ⊓ Z.1}}}
P: {0 ↦ {{[1,0] ⊓ P.0 ⊓ Q.0}}, 1 ↦ {{[1,1] ⊓ P.1 ⊓ Q.1}}, 2 ↦ {{[0,1] ⊓ P.2}}}
Q: {0 ↦ {{[1,0] ⊓ P.0 ⊓ Q.0}}, 1 ↦ {{[2,1] ⊓ Q.1}}}
M: {0 ↦ {{[0,1] ⊓ M.0}}, 1 ↦ {{[2,1] ⊓ M.1}}}
U: {0 ↦ {{[0,1] ⊓ U.0 ⊓ W.0} ⊔ {[1,0] ⊓ U.0 ⊓ V.0}}, 1 ↦ {{[1,0] ⊓ U.1 ⊓ V.1}}, 2 ↦ {{[0,1] ⊓ U.2 ⊓ W.1}}}
V: {0 ↦ {{[1,0] ⊓ U.0 ⊓ V.0}}, 1 ↦ {{[1,0] ⊓ U.1 ⊓ V.1}}}
W: {0 ↦ {{[0,1] ⊓ U.0 ⊓ W.0}}, 1 ↦ {{[0,1] ⊓ U.2 ⊓ W.1}}}
C1: {0 ↦ {{[0,1] ⊓ F.0 ⊓ H.0}}, 1 ↦ {{[2,1]}}}
...
list_inner: {0 ↦ ⊥, 1 ↦ {{[1,0]}}}
list_outer: {0 ↦ ⊥, 1 ↦ {{[1,0]}}}
list2: {0 ↦ {{[2,1] ⊓ cons.0} ⊔ {[2,1] ⊓ nil.0}}, 1 ↦ {{[2,1] ⊓ cons.1}}}
list2_inner: {0 ↦ {{[2,1] ⊓ cons.0} ⊔ {[2,1] ⊓ nil.0}}, 1 ↦ {{[1,0] ⊓ cons.1}}}
list2_outer: {0 ↦ {{[1,0] ⊓ cons.0} ⊔ {[1,0] ⊓ nil.0}}, 1 ↦ {{[1,0] ⊓ cons.1}}}
modal_plus: {0 ↦ {{[1,0]}}, 1 ↦ {{[2,1]}}}
modal_pair: {0 ↦ {{[1,0]}}, 1 ↦ {{[2,1]}}}
```
...
oddlist: {0 ↦ {{[2,1] ⊓ cons.0}}, 1 ↦ {{[2,1] ⊓ cons.1}}}
evenlist: {0 ↦ {{[2,1] ⊓ cons.0}}, 1 ↦ {{[2,1] ⊓ cons.1}}}
```
...
list: {0 ↦ ⊥, 1 ↦ {{[2,1]}}}
lily: {0 ↦ {{[2,1] ⊓ portable.0}}, 1 ↦ {{[2,1] ⊓ portable.1}}}
tulip: {0 ↦ {{[2,1] ⊓ portable.0}}, 1 ↦ {{[2,1]}}}
orchid: {0 ↦ {{[2,1] ⊓ portable.0}}, 1 ↦ {{[2,1] ⊓ portable.1}}}
```
...
Infer2 normalized kinds:
foo: {0 ↦ {{[2,1] ⊓ portended.0} ⊔ {[2,1] ⊓ portended.1 ⊓ ref.0}}, 1 ↦ {{[2,1] ⊓ portended.1 ⊓ ref.1}}}
```
...
list: {0 ↦ {{[2,1] ⊓ cons.0}}, 1 ↦ {{[2,1] ⊓ cons.1}}}
ctx: {0 ↦ {{[2,1] ⊓ down.0}}, 1 ↦ {{[2,1] ⊓ down.1}}}
zipper: {0 ↦ {{[2,1] ⊓ cons.0} ⊔ {[2,1] ⊓ down.0}}, 1 ↦ {{[2,1] ⊓ cons.1} ⊔ {[2,1] ⊓ down.1}}}
```
