...
M1: {0 ↦ [1,0], 1 ↦ ⊥}
M2: {0 ↦ [0,1], 1 ↦ [2,0]}
AC: {0 ↦ ([1,0] ⊓ AC.0), 1 ↦ ([1,0] ⊓ AC.1)}
PH: {0 ↦ ⊥, 1 ↦ PH.1, 2 ↦ ⊥}
X1: {0 ↦ X2.0, 1 ↦ ⊤}
X2: {0 ↦ ([0,1] ⊓ X2.0), 1 ↦ ⊥}
S: {0 ↦ (([1,0] ⊓ S.0 ⊓ T.0) ⊔ ([0,1] ⊓ S.0 ⊓ U.0)), 1 ↦ (([1,0] ⊓ S.1 ⊓ T.0) ⊔ ([1,0] ⊓ S.1 ⊓ T.1) ⊔ ([0,1] ⊓ S.1 ⊓ U.0) ⊔ ([0,1] ⊓ S.1 ⊓ U.1))}
...
ND2: {0 ↦ (([0,1] ⊓ A.0 ⊓ ND2.0) ⊔ ([0,1] ⊓ A.1 ⊓ D.0 ⊓ ND2.0) ⊔ ([1,0] ⊓ B.0 ⊓ ND2.0) ⊔ ([1,0] ⊓ B.1 ⊓ C.0 ⊓ ND2.0)), 1 ↦ (([0,1] ⊓ A.0 ⊓ ND2.1) ⊔ ([0,1] ⊓ A.1 ⊓ D.0 ⊓ ND2.1) ⊔ ([0,1] ⊓ A.1 ⊓ D.1 ⊓ ND2.1) ⊔ ([1,0] ⊓ B.0 ⊓ ND2.1) ⊔ ([1,0] ⊓ B.1 ⊓ C.0 ⊓ ND2.1) ⊔ ([1,0] ⊓ B.1 ⊓ C.1 ⊓ ND2.1))}
ND3: {0 ↦ (([1,1] ⊓ B.0 ⊓ ND3.0 ⊓ U3.1) ⊔ ([0,1] ⊓ C.0 ⊓ ND3.0 ⊓ X2.1) ⊔ ([1,1] ⊓ D.0 ⊓ ND3.0 ⊓ U3.2) ⊔ ([1,1] ⊓ ND3.0 ⊓ U3.0) ⊔ ([0,1] ⊓ ND3.0 ⊓ X2.0)), 1 ↦ (([1,1] ⊓ B.0 ⊓ ND3.1 ⊓ U3.1) ⊔ ([1,1] ⊓ B.1 ⊓ ND3.1 ⊓ U3.1) ⊔ ([0,1] ⊓ C.0 ⊓ ND3.1 ⊓ X2.1) ⊔ ([0,1] ⊓ C.1 ⊓ ND3.1 ⊓ X2.1) ⊔ ([1,1] ⊓ D.0 ⊓ ND3.1 ⊓ U3.2) ⊔ ([1,1] ⊓ ND3.1 ⊓ U3.0) ⊔ ([0,1] ⊓ ND3.1 ⊓ X2.0)), 2 ↦ (([1,1] ⊓ B.0 ⊓ ND3.2 ⊓ U3.1) ⊔ ([0,1] ⊓ C.0 ⊓ ND3.2 ⊓ X2.1) ⊔ ([1,1] ⊓ D.0 ⊓ ND3.2 ⊓ U3.2) ⊔ ([1,1] ⊓ D.1 ⊓ ND3.2 ⊓ U3.2) ⊔ ([1,1] ⊓ ND3.2 ⊓ U3.0) ⊔ ([0,1] ⊓ ND3.2 ⊓ X2.0))}
CN1: {0 ↦ [1,1], 1 ↦ ⊥}
CN2: {0 ↦ (A.0 ⊔ B.0), 1 ↦ ⊥, 2 ↦ ⊥}
NestSTU: {0 ↦ ((NestSTU.0 ⊓ S.0 ⊓ T.1 ⊓ U.1) ⊔ (NestSTU.0 ⊓ T.0) ⊔ (NestSTU.0 ⊓ T.1 ⊓ U.0)), 1 ↦ ((NestSTU.1 ⊓ S.0 ⊓ T.1 ⊓ U.1) ⊔ (NestSTU.1 ⊓ S.1 ⊓ T.1 ⊓ U.1) ⊔ (NestSTU.1 ⊓ T.0) ⊔ (NestSTU.1 ⊓ T.1 ⊓ U.0))}
AnnNest: {0 ↦ ⊥, 1 ↦ ([1,1] ⊓ AnnNest.1)}
RecNest1: {0 ↦ ((C.0 ⊓ RecNest1.0 ⊓ RecNest2.1) ⊔ (RecNest1.0 ⊓ RecNest2.0)), 1 ↦ RecNest1.1}
RecNest2: {0 ↦ (([0,1] ⊓ D.0 ⊓ RecNest1.1 ⊓ RecNest2.0) ⊔ ([0,1] ⊓ RecNest1.0 ⊓ RecNest2.0)), 1 ↦ (([0,1] ⊓ D.0 ⊓ RecNest1.1 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.1 ⊓ RecNest1.1 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ RecNest1.0 ⊓ RecNest2.1))}
MixNest: {0 ↦ ((B.0 ⊓ MixNest.0 ⊓ U3.1) ⊔ ([1,0] ⊓ C.0 ⊓ MixNest.0 ⊓ Z1.1) ⊔ (D.0 ⊓ MixNest.0 ⊓ U3.2) ⊔ (MixNest.0 ⊓ U3.0) ⊔ ([1,0] ⊓ MixNest.0 ⊓ Z1.0)), 1 ↦ ((B.0 ⊓ MixNest.1 ⊓ U3.1) ⊔ (B.1 ⊓ MixNest.1 ⊓ U3.1) ⊔ ([1,0] ⊓ C.0 ⊓ MixNest.1 ⊓ Z1.1) ⊔ ([1,0] ⊓ C.1 ⊓ MixNest.1 ⊓ Z1.1) ⊔ (D.0 ⊓ MixNest.1 ⊓ U3.2) ⊔ (MixNest.1 ⊓ U3.0) ⊔ ([1,0] ⊓ MixNest.1 ⊓ Z1.0)), 2 ↦ ((B.0 ⊓ MixNest.2 ⊓ U3.1) ⊔ ([1,0] ⊓ C.0 ⊓ MixNest.2 ⊓ Z1.1) ⊔ (D.0 ⊓ MixNest.2 ⊓ U3.2) ⊔ (D.1 ⊓ MixNest.2 ⊓ U3.2) ⊔ (MixNest.2 ⊓ U3.0) ⊔ ([1,0] ⊓ MixNest.2 ⊓ Z1.0) ⊔ ([1,0] ⊓ MixNest.2 ⊓ Z1.2))}
A0: {0 ↦ ([1,0] ⊓ A0.0 ⊓ B0.0)}
B0: {0 ↦ (A0.0 ⊓ B0.0)}
...
PRF: {0 ↦ (([0,1] ⊓ PRD.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRD.1 ⊓ PRF.0)), 1 ↦ (([0,1] ⊓ PRD.0 ⊓ PRF.1) ⊔ ([0,1] ⊓ PRD.1 ⊓ PRF.1) ⊔ ([1,0] ⊓ PRF.1))}
...
PCY: {0 ↦ ⊥, 1 ↦ ⊤}
PCZ: {0 ↦ ⊥, 1 ↦ ⊤}
PRG: {0 ↦ (([1,0] ⊓ PRG.0 ⊓ PRH.0) ⊔ ([1,0] ⊓ PRG.0 ⊓ PRH.1)), 1 ↦ PRG.1, 2 ↦ (([1,0] ⊓ PRG.1 ⊓ PRG.2 ⊓ PRH.1) ⊔ ([1,0] ⊓ PRG.2 ⊓ PRH.0))}
PRH: {0 ↦ (([0,1] ⊓ PRG.0 ⊓ PRH.0) ⊔ ([0,1] ⊓ PRG.1 ⊓ PRH.0)), 1 ↦ (([0,1] ⊓ PRG.0 ⊓ PRH.1) ⊔ ([0,1] ⊓ PRG.1 ⊓ PRH.1) ⊔ ([0,1] ⊓ PRG.2 ⊓ PRH.1)), 2 ↦ PRH.2}
CA: {0 ↦ ([0,1] ⊓ CA.0), 1 ↦ CA.1}
CC: {0 ↦ CA.0, 1 ↦ ([1,0] ⊔ CA.1)}
CA2: {0 ↦ ([1,0] ⊓ CA2.0), 1 ↦ ([0,1] ⊓ CA2.1), 2 ↦ ⊥}
CC2: {0 ↦ CA2.0, 1 ↦ CA2.1, 2 ↦ ([1,0] ⊔ CA2.2)}
CA0: {0 ↦ ([0,1] ⊓ CA0.0)}
CC0: {0 ↦ CA0.0}
CAX: {0 ↦ ((CAX.0 ⊓ CCX.0) ⊔ (CAX.0 ⊓ CCX.1)), 1 ↦ (([0,1] ⊓ CAX.1) ⊔ ([2,0] ⊓ CAX.1 ⊓ CCX.0))}
...
X2: {0 ↦ ([0,1] ⊓ X2.0), 1 ↦ ([0,1] ⊓ X2.1)}
S: {0 ↦ (([1,0] ⊓ S.0 ⊓ T.0) ⊔ ([0,1] ⊓ S.0 ⊓ U.0)), 1 ↦ (([1,0] ⊓ S.1 ⊓ T.1) ⊔ ([0,1] ⊓ S.1 ⊓ U.1))}
T: {0 ↦ (([1,0] ⊓ S.0 ⊓ T.0) ⊔ ([0,1] ⊓ S.0 ⊓ T.0 ⊓ U.0)), 1 ↦ (([0,1] ⊓ S.0 ⊓ T.1 ⊓ U.0) ⊔ ([1,0] ⊓ S.1 ⊓ T.1) ⊔ ([0,1] ⊓ S.1 ⊓ T.1 ⊓ U.1))}
U: {0 ↦ ([0,1] ⊓ S.0 ⊓ U.0), 1 ↦ ([0,1] ⊓ S.1 ⊓ U.1)}
Z1: {0 ↦ ([0,1] ⊓ Z1.0), 1 ↦ ([1,1] ⊓ Z1.1), 2 ↦ ([1,1] ⊓ Z1.2)}
DUP: {0 ↦ [1,1], 1 ↦ [2,0]}
SW: {0 ↦ ([1,1] ⊓ SW.0), 1 ↦ ([1,1] ⊓ SW.1), 2 ↦ ([1,1] ⊓ SW.2)}
...
CN1: {0 ↦ [1,1], 1 ↦ (([2,0] ⊓ A.1 ⊓ C.1) ⊔ ([1,0] ⊓ D.1))}
...
C3: {0 ↦ ([0,1] ⊓ Z3.0), 1 ↦ (([0,1] ⊓ Z3.0 ⊓ Z3.3) ⊔ ([0,1] ⊓ Z3.1 ⊓ Z3.3)), 2 ↦ ([0,1] ⊓ Z3.1), 3 ↦ (([0,1] ⊓ Z3.0 ⊓ Z3.2) ⊔ ([0,1] ⊓ Z3.1 ⊓ Z3.2 ⊓ Z3.3) ⊔ ([1,0] ⊓ Z3.2))}
DupSelf: {0 ↦ (([1,0] ⊓ DupSelf.0 ⊓ S.0 ⊓ T.0) ⊔ ([0,1] ⊓ DupSelf.0 ⊓ S.0 ⊓ U.0)), 1 ↦ (([1,0] ⊓ DupSelf.1 ⊓ S.0 ⊓ T.0) ⊔ ([0,1] ⊓ DupSelf.1 ⊓ S.0 ⊓ U.0) ⊔ ([1,0] ⊓ DupSelf.1 ⊓ S.1 ⊓ T.1) ⊔ ([0,1] ⊓ DupSelf.1 ⊓ S.1 ⊓ U.1))}
...
Infer2 & Classic normalized kinds:
list: {0 ↦ ⊥, 1 ↦ list.1}
rose: {0 ↦ ⊥, 1 ↦ list.1}
lily: {0 ↦ ⊥, 1 ↦ ⊥}
```
...
X: {0 ↦ (([1,0] ⊓ X.0 ⊓ Y.0) ⊔ ([0,1] ⊓ X.0 ⊓ Z.0)), 1 ↦ (([1,0] ⊓ X.1 ⊓ Y.0) ⊔ ([1,0] ⊓ X.1 ⊓ Y.1) ⊔ ([0,1] ⊓ X.1 ⊓ Z.0) ⊔ ([0,1] ⊓ X.1 ⊓ Z.1))}
Y: {0 ↦ (X.0 ⊓ Y.0), 1 ↦ Y.1}
...
W: {0 ↦ ([0,1] ⊓ U.0 ⊓ W.0), 1 ↦ ([0,1] ⊓ U.2 ⊓ W.1)}
C1: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ ⊤}
C2: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ ([1,0] ⊔ ([0,1] ⊓ F.0 ⊓ F.1 ⊓ H.0) ⊔ ([0,1] ⊓ F.1 ⊓ H.1))}
```
...
Program output:
```
Infer2 & Infer4 & Classic normalized kinds:
list: {0 ↦ ⊥, 1 ↦ ⊤}
```
...
inner_vs_outer: {0 ↦ ⊥, 1 ↦ [1,0]}
list_ann: {0 ↦ ⊥, 1 ↦ [1,0]}
two_axes: {0 ↦ (([1,0] ⊓ F.0) ⊔ ([0,1] ⊓ G.0)), 1 ↦ (([1,0] ⊓ F.1) ⊔ ([0,1] ⊓ G.1))}
