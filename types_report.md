...
Generated: 2025-08-21 19:32:52 UTC
...
[lfp] iter 1:
  ...
  PCY: {0 ↦ ⊥, 1 ↦ ⊤}
  PCZ: {0 ↦ ⊥, 1 ↦ ⊤}
  CC: {0 ↦ CA.0, 1 ↦ ([1,0] ⊔ CA.1)}
  CC2: {0 ↦ CA2.0, 1 ↦ CA2.1, 2 ↦ ([1,0] ⊔ CA2.2)}
  CC0: {0 ↦ CA0.0}
  CBX: {0 ↦ (CCX.0 ⊔ (CAX.0 ⊓ CCX.1)), 1 ↦ ⊤}
[lfp] iter 2:
  K: {0 ↦ (A.0 ⊔ B.0), 1 ↦ ⊤, 2 ↦ B.1}
  M1: {0 ↦ [1,1], 1 ↦ [2,0]}
  M2: {0 ↦ [0,1], 1 ↦ [2,0]}
...
[lfp] iter 3:
  ...
  X1: {0 ↦ X2.0, 1 ↦ ⊤}
  DUP: {0 ↦ [1,1], 1 ↦ [2,0]}
  CN1: {0 ↦ ([1,1] ⊔ ([2,0] ⊓ C.0) ⊔ ([2,0] ⊓ D.0)), 1 ↦ (([2,0] ⊓ C.1) ⊔ ([2,0] ⊓ D.1))}
  CN2: {0 ↦ ([0,1] ⊔ ([2,0] ⊓ A.0) ⊔ ([2,0] ⊓ B.0)), 1 ↦ ([2,0] ⊓ A.1), 2 ↦ ([2,0] ⊓ B.1)}
  C3: {0 ↦ Z3.0, 1 ↦ Z3.3, 2 ↦ Z3.1, 3 ↦ Z3.2}
  PCX: {0 ↦ ⊥, 1 ↦ [1,0]}
  PCY: {0 ↦ ⊥, 1 ↦ ⊤}
...
[lfp] iter 0:
  ...
  CCX: {0 ↦ CCX.0, 1 ↦ CCX.1}
[lfp] iter 1:
  A: {0 ↦ ([1,0] ⊓ A.0 ⊓ B.0), 1 ↦ A.1}
  B: {0 ↦ ([0,1] ⊓ B.0 ⊓ C.0), 1 ↦ (([0,1] ⊓ B.1 ⊓ C.0) ⊔ ([0,1] ⊓ B.1 ⊓ C.1))}
  C: {0 ↦ (A.0 ⊓ C.0), 1 ↦ ((A.0 ⊓ C.1) ⊔ (A.1 ⊓ C.1))}
  D: {0 ↦ (D.0 ⊓ E.0), 1 ↦ (([1,0] ⊓ D.1) ⊔ (D.1 ⊓ E.0) ⊔ (D.1 ⊓ E.2)), 2 ↦ ((D.2 ⊓ E.0) ⊔ (D.2 ⊓ E.1))}
  E: {0 ↦ ([0,1] ⊓ D.0 ⊓ E.0), 1 ↦ (([0,1] ⊓ D.0 ⊓ E.1) ⊔ ([0,1] ⊓ D.1 ⊓ E.1)), 2 ↦ ([0,1] ⊓ E.2)}
  R: {0 ↦ ([1,0] ⊓ R.0), 1 ↦ ([1,1] ⊓ R.1)}
  U1: {0 ↦ ([1,0] ⊓ U1.0 ⊓ U2.0), 1 ↦ (([0,1] ⊓ U1.1) ⊔ ([1,0] ⊓ U1.1 ⊓ U2.0)), 2 ↦ (([1,0] ⊓ U1.2 ⊓ U2.0) ⊔ ([1,0] ⊓ U1.2 ⊓ U2.1))}
  U2: {0 ↦ ([0,1] ⊓ U2.0 ⊓ U3.0), 1 ↦ (([0,1] ⊓ U2.1 ⊓ U3.0) ⊔ ([0,1] ⊓ U2.1 ⊓ U3.1) ⊔ ([0,1] ⊓ U2.1 ⊓ U3.2))}
  U3: {0 ↦ ([1,1] ⊓ U1.0 ⊓ U3.0), 1 ↦ (([1,1] ⊓ U1.0 ⊓ U3.1) ⊔ ([1,1] ⊓ U1.1 ⊓ U3.1)), 2 ↦ (([1,1] ⊓ U1.0 ⊓ U3.2) ⊔ ([1,1] ⊓ U1.2 ⊓ U3.2))}
  AC: {0 ↦ ⊥, 1 ↦ ([1,0] ⊓ AC.1)}
  PH: {0 ↦ ⊥, 1 ↦ PH.1, 2 ↦ ⊥}
  X2: {0 ↦ ([0,1] ⊓ X2.0), 1 ↦ ([0,1] ⊓ X2.1)}
  S: {0 ↦ ([0,1] ⊓ S.0 ⊓ U.0), 1 ↦ (([0,1] ⊓ S.1 ⊓ U.0) ⊔ ([0,1] ⊓ S.1 ⊓ U.1))}
  T: {0 ↦ (S.0 ⊓ T.0), 1 ↦ ((S.0 ⊓ T.1) ⊔ (S.1 ⊓ T.1))}
  U: {0 ↦ ([0,1] ⊓ S.0 ⊓ U.0), 1 ↦ (([0,1] ⊓ S.0 ⊓ U.1) ⊔ ([0,1] ⊓ S.1 ⊓ U.1))}
  Z1: {0 ↦ ([0,1] ⊓ Z1.0), 1 ↦ ([0,1] ⊓ Z1.1), 2 ↦ ([0,1] ⊓ Z1.2)}
  SW: {0 ↦ ([1,0] ⊓ SW.0), 1 ↦ ([1,0] ⊓ SW.1), 2 ↦ ([1,0] ⊓ SW.2)}
  ND1: {0 ↦ ((C.0 ⊓ ND1.0) ⊔ (C.1 ⊓ D.0 ⊓ ND1.0)), 1 ↦ ND1.1}
  ND2: {0 ↦ (([0,1] ⊓ A.0 ⊓ ND2.0) ⊔ ([1,0] ⊓ B.0 ⊓ ND2.0) ⊔ ([0,1] ⊓ A.1 ⊓ D.0 ⊓ ND2.0) ⊔ ([1,0] ⊓ B.1 ⊓ C.0 ⊓ ND2.0)), 1 ↦ (([0,1] ⊓ A.0 ⊓ ND2.1) ⊔ ([1,0] ⊓ B.0 ⊓ ND2.1) ⊔ ([0,1] ⊓ A.1 ⊓ D.0 ⊓ ND2.1) ⊔ ([0,1] ⊓ A.1 ⊓ D.1 ⊓ ND2.1) ⊔ ([1,0] ⊓ B.1 ⊓ C.0 ⊓ ND2.1) ⊔ ([1,0] ⊓ B.1 ⊓ C.1 ⊓ ND2.1))}
  ND3: {0 ↦ (([1,1] ⊓ ND3.0 ⊓ U3.0) ⊔ ([0,1] ⊓ ND3.0 ⊓ X2.0) ⊔ ([1,1] ⊓ B.0 ⊓ ND3.0 ⊓ U3.1) ⊔ ([0,1] ⊓ C.0 ⊓ ND3.0 ⊓ X2.1) ⊔ ([1,1] ⊓ D.0 ⊓ ND3.0 ⊓ U3.2)), 1 ↦ (([1,1] ⊓ ND3.1 ⊓ U3.0) ⊔ ([0,1] ⊓ ND3.1 ⊓ X2.0) ⊔ ([1,1] ⊓ B.0 ⊓ ND3.1 ⊓ U3.1) ⊔ ([1,1] ⊓ B.1 ⊓ ND3.1 ⊓ U3.1) ⊔ ([0,1] ⊓ C.0 ⊓ ND3.1 ⊓ X2.1) ⊔ ([0,1] ⊓ C.1 ⊓ ND3.1 ⊓ X2.1) ⊔ ([1,1] ⊓ D.0 ⊓ ND3.1 ⊓ U3.2)), 2 ↦ (([1,1] ⊓ ND3.2 ⊓ U3.0) ⊔ ([0,1] ⊓ ND3.2 ⊓ X2.0) ⊔ ([1,1] ⊓ B.0 ⊓ ND3.2 ⊓ U3.1) ⊔ ([0,1] ⊓ C.0 ⊓ ND3.2 ⊓ X2.1) ⊔ ([1,1] ⊓ D.0 ⊓ ND3.2 ⊓ U3.2) ⊔ ([1,1] ⊓ D.1 ⊓ ND3.2 ⊓ U3.2))}
  NestSTU: {0 ↦ ((NestSTU.0 ⊓ T.0) ⊔ (NestSTU.0 ⊓ T.1 ⊓ U.0) ⊔ (NestSTU.0 ⊓ S.0 ⊓ T.1 ⊓ U.1)), 1 ↦ ((NestSTU.1 ⊓ T.0) ⊔ (NestSTU.1 ⊓ T.1 ⊓ U.0) ⊔ (NestSTU.1 ⊓ S.0 ⊓ T.1 ⊓ U.1) ⊔ (NestSTU.1 ⊓ S.1 ⊓ T.1 ⊓ U.1))}
  AnnNest: {0 ↦ ⊥, 1 ↦ ([1,1] ⊓ AnnNest.1)}
  RecNest1: {0 ↦ ((RecNest1.0 ⊓ RecNest2.0) ⊔ (C.0 ⊓ RecNest1.0 ⊓ RecNest2.1)), 1 ↦ RecNest1.1}
  RecNest2: {0 ↦ (([0,1] ⊓ RecNest1.0 ⊓ RecNest2.0) ⊔ ([0,1] ⊓ D.0 ⊓ RecNest1.1 ⊓ RecNest2.0)), 1 ↦ (([0,1] ⊓ RecNest1.0 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.0 ⊓ RecNest1.1 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.1 ⊓ RecNest1.1 ⊓ RecNest2.1))}
  MixNest: {0 ↦ ((MixNest.0 ⊓ U3.0) ⊔ ([1,0] ⊓ MixNest.0 ⊓ Z1.0) ⊔ (B.0 ⊓ MixNest.0 ⊓ U3.1) ⊔ ([1,0] ⊓ C.0 ⊓ MixNest.0 ⊓ Z1.1) ⊔ (D.0 ⊓ MixNest.0 ⊓ U3.2)), 1 ↦ ((MixNest.1 ⊓ U3.0) ⊔ ([1,0] ⊓ MixNest.1 ⊓ Z1.0) ⊔ (B.0 ⊓ MixNest.1 ⊓ U3.1) ⊔ (B.1 ⊓ MixNest.1 ⊓ U3.1) ⊔ ([1,0] ⊓ C.0 ⊓ MixNest.1 ⊓ Z1.1) ⊔ ([1,0] ⊓ C.1 ⊓ MixNest.1 ⊓ Z1.1) ⊔ (D.0 ⊓ MixNest.1 ⊓ U3.2)), 2 ↦ ((MixNest.2 ⊓ U3.0) ⊔ ([1,0] ⊓ MixNest.2 ⊓ Z1.0) ⊔ ([1,0] ⊓ MixNest.2 ⊓ Z1.2) ⊔ (B.0 ⊓ MixNest.2 ⊓ U3.1) ⊔ ([1,0] ⊓ C.0 ⊓ MixNest.2 ⊓ Z1.1) ⊔ (D.0 ⊓ MixNest.2 ⊓ U3.2) ⊔ (D.1 ⊓ MixNest.2 ⊓ U3.2))}
  A0: {0 ↦ ([1,0] ⊓ A0.0 ⊓ B0.0)}
  B0: {0 ↦ (A0.0 ⊓ B0.0)}
  Z3: {0 ↦ ([0,1] ⊓ Z3.0), 1 ↦ ([0,1] ⊓ Z3.1), 2 ↦ (([1,0] ⊓ Z3.2) ⊔ ([0,1] ⊓ Z3.2 ⊓ Z3.3)), 3 ↦ ([0,1] ⊓ Z3.1 ⊓ Z3.3)}
  DupSelf: {0 ↦ (DupSelf.0 ⊓ S.0), 1 ↦ ((DupSelf.1 ⊓ S.0) ⊔ (DupSelf.1 ⊓ S.1))}
  PRF: {0 ↦ (([0,1] ⊓ PRD.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRD.1 ⊓ PRF.0)), 1 ↦ (([1,0] ⊓ PRF.1) ⊔ ([0,1] ⊓ PRD.0 ⊓ PRF.1) ⊔ ([0,1] ⊓ PRD.1 ⊓ PRF.1))}
  PRE: {0 ↦ (([0,1] ⊓ PRE.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRE.0 ⊓ PRF.1)), 1 ↦ PRE.1}
  PRC: {0 ↦ (([1,0] ⊓ PRC.0 ⊓ PRD.0) ⊔ ([1,0] ⊓ PRC.0 ⊓ PRD.1)), 1 ↦ (([0,1] ⊓ PRC.1) ⊔ ([1,0] ⊓ PRC.1 ⊓ PRD.0) ⊔ ([1,0] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRE.0) ⊔ ([1,0] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRE.1))}
  PRD: {0 ↦ ([0,1] ⊓ PRC.0 ⊓ PRD.0), 1 ↦ (([0,1] ⊓ PRC.0 ⊓ PRD.1) ⊔ ([0,1] ⊓ PRC.1 ⊓ PRD.1))}
  PRG: {0 ↦ (([1,0] ⊓ PRG.0 ⊓ PRH.0) ⊔ ([1,0] ⊓ PRG.0 ⊓ PRH.1)), 1 ↦ PRG.1, 2 ↦ (([1,0] ⊓ PRG.2 ⊓ PRH.0) ⊔ ([1,0] ⊓ PRG.1 ⊓ PRG.2 ⊓ PRH.1))}
  PRH: {0 ↦ (([0,1] ⊓ PRG.0 ⊓ PRH.0) ⊔ ([0,1] ⊓ PRG.1 ⊓ PRH.0)), 1 ↦ (([0,1] ⊓ PRG.0 ⊓ PRH.1) ⊔ ([0,1] ⊓ PRG.1 ⊓ PRH.1) ⊔ ([0,1] ⊓ PRG.2 ⊓ PRH.1)), 2 ↦ PRH.2}
...
[lfp] iter 2:
  A: {0 ↦ ⊥, 1 ↦ A.1}
  B: {0 ↦ ([0,1] ⊓ A.0 ⊓ B.0 ⊓ C.0), 1 ↦ (([0,1] ⊓ A.0 ⊓ B.1 ⊓ C.0) ⊔ ([0,1] ⊓ A.0 ⊓ B.1 ⊓ C.1) ⊔ ([0,1] ⊓ A.1 ⊓ B.1 ⊓ C.1))}
  C: {0 ↦ ([1,0] ⊓ A.0 ⊓ B.0 ⊓ C.0), 1 ↦ ((A.1 ⊓ C.1) ⊔ ([1,0] ⊓ A.0 ⊓ B.0 ⊓ C.1))}
  D: {0 ↦ ([0,1] ⊓ D.0 ⊓ E.0), 1 ↦ (([1,0] ⊓ D.1) ⊔ ([0,1] ⊓ D.1 ⊓ E.2)), 2 ↦ (([0,1] ⊓ D.0 ⊓ D.2 ⊓ E.1) ⊔ ([0,1] ⊓ D.1 ⊓ D.2 ⊓ E.1))}
  E: {0 ↦ ([0,1] ⊓ D.0 ⊓ E.0), 1 ↦ (([0,1] ⊓ D.1 ⊓ E.0 ⊓ E.1) ⊔ ([0,1] ⊓ D.1 ⊓ E.1 ⊓ E.2)), 2 ↦ ([0,1] ⊓ E.2)}
  R: {0 ↦ ([1,0] ⊓ R.0), 1 ↦ ([1,1] ⊓ R.1)}
  U1: {0 ↦ ⊥, 1 ↦ ([0,1] ⊓ U1.1), 2 ↦ ⊥}
  U2: {0 ↦ ([0,1] ⊓ U1.0 ⊓ U2.0 ⊓ U3.0), 1 ↦ (([0,1] ⊓ U1.0 ⊓ U2.1 ⊓ U3.0) ⊔ ([0,1] ⊓ U1.0 ⊓ U2.1 ⊓ U3.1) ⊔ ([0,1] ⊓ U1.0 ⊓ U2.1 ⊓ U3.2) ⊔ ([0,1] ⊓ U1.1 ⊓ U2.1 ⊓ U3.1) ⊔ ([0,1] ⊓ U1.2 ⊓ U2.1 ⊓ U3.2))}
  U3: {0 ↦ ([1,0] ⊓ U1.0 ⊓ U2.0 ⊓ U3.0), 1 ↦ (([0,1] ⊓ U1.1 ⊓ U3.1) ⊔ ([1,0] ⊓ U1.0 ⊓ U2.0 ⊓ U3.1) ⊔ ([1,0] ⊓ U1.1 ⊓ U2.0 ⊓ U3.1)), 2 ↦ (([1,0] ⊓ U1.0 ⊓ U2.0 ⊓ U3.2) ⊔ ([1,0] ⊓ U1.2 ⊓ U2.0 ⊓ U3.2) ⊔ ([1,0] ⊓ U1.2 ⊓ U2.1 ⊓ U3.2))}
  AC: {0 ↦ ⊥, 1 ↦ ([1,0] ⊓ AC.1)}
  PH: {0 ↦ ⊥, 1 ↦ PH.1, 2 ↦ ⊥}
  X2: {0 ↦ ([0,1] ⊓ X2.0), 1 ↦ ([0,1] ⊓ X2.1)}
  S: {0 ↦ ([0,1] ⊓ S.0 ⊓ U.0), 1 ↦ ([0,1] ⊓ S.1 ⊓ U.1)}
  T: {0 ↦ ([0,1] ⊓ S.0 ⊓ T.0 ⊓ U.0), 1 ↦ (([0,1] ⊓ S.0 ⊓ T.1 ⊓ U.0) ⊔ ([0,1] ⊓ S.1 ⊓ T.1 ⊓ U.0) ⊔ ([0,1] ⊓ S.1 ⊓ T.1 ⊓ U.1))}
  U: {0 ↦ ([0,1] ⊓ S.0 ⊓ U.0), 1 ↦ ([0,1] ⊓ S.1 ⊓ U.1)}
  Z1: {0 ↦ ([0,1] ⊓ Z1.0), 1 ↦ ([0,1] ⊓ Z1.1), 2 ↦ ([0,1] ⊓ Z1.2)}
  SW: {0 ↦ ([1,0] ⊓ SW.0), 1 ↦ ([1,0] ⊓ SW.1), 2 ↦ ([1,0] ⊓ SW.2)}
  ND1: {0 ↦ ((A.0 ⊓ C.0 ⊓ ND1.0) ⊔ (A.0 ⊓ C.1 ⊓ D.0 ⊓ E.0 ⊓ ND1.0) ⊔ (A.1 ⊓ C.1 ⊓ D.0 ⊓ E.0 ⊓ ND1.0)), 1 ↦ ND1.1}
  ND2: {0 ↦ ([0,1] ⊓ A.1 ⊓ D.0 ⊓ E.0 ⊓ ND2.0), 1 ↦ (([0,1] ⊓ A.1 ⊓ D.0 ⊓ E.0 ⊓ ND2.1) ⊔ ([0,1] ⊓ A.1 ⊓ D.1 ⊓ E.0 ⊓ ND2.1) ⊔ ([0,1] ⊓ A.1 ⊓ D.1 ⊓ E.2 ⊓ ND2.1))}
  ND3: {0 ↦ (([0,1] ⊓ ND3.0 ⊓ X2.0) ⊔ ([1,1] ⊓ ND3.0 ⊓ U1.0 ⊓ U3.0) ⊔ ([0,1] ⊓ A.0 ⊓ C.0 ⊓ ND3.0 ⊓ X2.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ ND3.0 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ ND3.0 ⊓ U1.1 ⊓ U3.1) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ ND3.0 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ ND3.0 ⊓ U1.2 ⊓ U3.2)), 1 ↦ (([0,1] ⊓ ND3.1 ⊓ X2.0) ⊔ ([1,1] ⊓ ND3.1 ⊓ U1.0 ⊓ U3.0) ⊔ ([0,1] ⊓ A.0 ⊓ C.0 ⊓ ND3.1 ⊓ X2.1) ⊔ ([0,1] ⊓ A.0 ⊓ C.1 ⊓ ND3.1 ⊓ X2.1) ⊔ ([0,1] ⊓ A.1 ⊓ C.1 ⊓ ND3.1 ⊓ X2.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ ND3.1 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.0 ⊓ ND3.1 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.0 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.1 ⊓ ND3.1 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.1 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ ND3.1 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ ND3.1 ⊓ U1.2 ⊓ U3.2)), 2 ↦ (([0,1] ⊓ ND3.2 ⊓ X2.0) ⊔ ([1,1] ⊓ ND3.2 ⊓ U1.0 ⊓ U3.0) ⊔ ([0,1] ⊓ A.0 ⊓ C.0 ⊓ ND3.2 ⊓ X2.1) ⊔ ([1,0] ⊓ D.1 ⊓ ND3.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,0] ⊓ D.1 ⊓ ND3.2 ⊓ U1.2 ⊓ U3.2) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ ND3.2 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ ND3.2 ⊓ U1.1 ⊓ U3.1) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ ND3.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ ND3.2 ⊓ U1.2 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.0 ⊓ ND3.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.0 ⊓ ND3.2 ⊓ U1.2 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.2 ⊓ ND3.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.2 ⊓ ND3.2 ⊓ U1.2 ⊓ U3.2))}
  NestSTU: {0 ↦ ((NestSTU.0 ⊓ S.0 ⊓ T.0) ⊔ ([0,1] ⊓ NestSTU.0 ⊓ S.0 ⊓ T.1 ⊓ U.0)), 1 ↦ ((NestSTU.1 ⊓ S.0 ⊓ T.0) ⊔ ([0,1] ⊓ NestSTU.1 ⊓ S.0 ⊓ T.1 ⊓ U.0) ⊔ ([0,1] ⊓ NestSTU.1 ⊓ S.1 ⊓ T.1 ⊓ U.1))}
  AnnNest: {0 ↦ ⊥, 1 ↦ ([1,1] ⊓ AnnNest.1)}
  RecNest1: {0 ↦ (([0,1] ⊓ RecNest1.0 ⊓ RecNest2.0) ⊔ ([0,1] ⊓ A.0 ⊓ C.0 ⊓ RecNest1.0 ⊓ RecNest2.1)), 1 ↦ RecNest1.1}
  RecNest2: {0 ↦ (([0,1] ⊓ RecNest1.0 ⊓ RecNest2.0) ⊔ ([0,1] ⊓ D.0 ⊓ E.0 ⊓ RecNest1.1 ⊓ RecNest2.0)), 1 ↦ (([0,1] ⊓ C.0 ⊓ RecNest1.0 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.0 ⊓ E.0 ⊓ RecNest1.1 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.1 ⊓ E.0 ⊓ RecNest1.1 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.1 ⊓ E.2 ⊓ RecNest1.1 ⊓ RecNest2.1))}
  MixNest: {0 ↦ (([1,1] ⊓ MixNest.0 ⊓ U1.0 ⊓ U3.0) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ MixNest.0 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ MixNest.0 ⊓ U1.1 ⊓ U3.1) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ MixNest.0 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ MixNest.0 ⊓ U1.2 ⊓ U3.2)), 1 ↦ (([1,1] ⊓ MixNest.1 ⊓ U1.0 ⊓ U3.0) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ MixNest.1 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ MixNest.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.0 ⊓ MixNest.1 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.0 ⊓ MixNest.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.1 ⊓ MixNest.1 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.1 ⊓ MixNest.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ MixNest.1 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ MixNest.1 ⊓ U1.2 ⊓ U3.2)), 2 ↦ (([1,1] ⊓ MixNest.2 ⊓ U1.0 ⊓ U3.0) ⊔ ([1,0] ⊓ D.1 ⊓ MixNest.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,0] ⊓ D.1 ⊓ MixNest.2 ⊓ U1.2 ⊓ U3.2) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ MixNest.2 ⊓ U1.0 ⊓ U3.1) ⊔ ([0,1] ⊓ B.0 ⊓ C.0 ⊓ MixNest.2 ⊓ U1.1 ⊓ U3.1) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ MixNest.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([1,1] ⊓ D.0 ⊓ E.0 ⊓ MixNest.2 ⊓ U1.2 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.0 ⊓ MixNest.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.0 ⊓ MixNest.2 ⊓ U1.2 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.2 ⊓ MixNest.2 ⊓ U1.0 ⊓ U3.2) ⊔ ([0,1] ⊓ D.1 ⊓ E.2 ⊓ MixNest.2 ⊓ U1.2 ⊓ U3.2))}
  A0: {0 ↦ ([1,0] ⊓ A0.0 ⊓ B0.0)}
  B0: {0 ↦ ([1,0] ⊓ A0.0 ⊓ B0.0)}
  Z3: {0 ↦ ([0,1] ⊓ Z3.0), 1 ↦ ([0,1] ⊓ Z3.1), 2 ↦ (([1,0] ⊓ Z3.2) ⊔ ([0,1] ⊓ Z3.1 ⊓ Z3.2 ⊓ Z3.3)), 3 ↦ ([0,1] ⊓ Z3.1 ⊓ Z3.3)}
  DupSelf: {0 ↦ ([0,1] ⊓ DupSelf.0 ⊓ S.0 ⊓ U.0), 1 ↦ (([0,1] ⊓ DupSelf.1 ⊓ S.0 ⊓ U.0) ⊔ ([0,1] ⊓ DupSelf.1 ⊓ S.1 ⊓ U.0) ⊔ ([0,1] ⊓ DupSelf.1 ⊓ S.1 ⊓ U.1))}
  PRF: {0 ↦ (([0,1] ⊓ PRC.0 ⊓ PRD.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRC.0 ⊓ PRD.1 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRF.0)), 1 ↦ (([1,0] ⊓ PRF.1) ⊔ ([0,1] ⊓ PRC.0 ⊓ PRD.0 ⊓ PRF.1) ⊔ ([0,1] ⊓ PRC.0 ⊓ PRD.1 ⊓ PRF.1) ⊔ ([0,1] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRF.1))}
  PRE: {0 ↦ (([0,1] ⊓ PRD.0 ⊓ PRE.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRD.0 ⊓ PRE.0 ⊓ PRF.1) ⊔ ([0,1] ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.1)), 1 ↦ PRE.1}
  PRC: {0 ↦ ⊥, 1 ↦ ([0,1] ⊓ PRC.1)}
...
[lfp] iter 3:
  ...
  C: {0 ↦ ⊥, 1 ↦ (A.1 ⊓ C.1)}
  D: {0 ↦ ([0,1] ⊓ D.0 ⊓ E.0), 1 ↦ (([1,0] ⊓ D.1) ⊔ ([0,1] ⊓ D.1 ⊓ E.2)), 2 ↦ (([0,1] ⊓ D.1 ⊓ D.2 ⊓ E.0 ⊓ E.1) ⊔ ([0,1] ⊓ D.1 ⊓ D.2 ⊓ E.1 ⊓ E.2))}
  ...
  Z1: {0 ↦ ([0,1] ⊓ Z1.0), 1 ↦ ([0,1] ⊓ Z1.1), 2 ↦ ([0,1] ⊓ Z1.2)}
  SW: {0 ↦ ([1,0] ⊓ SW.0), 1 ↦ ([1,0] ⊓ SW.1), 2 ↦ ([1,0] ⊓ SW.2)}
  ND1: {0 ↦ (([1,0] ⊓ A.0 ⊓ B.0 ⊓ C.0 ⊓ ND1.0) ⊔ ([0,1] ⊓ A.1 ⊓ C.1 ⊓ D.0 ⊓ E.0 ⊓ ND1.0)), 1 ↦ ND1.1}
  ND2: {0 ↦ ([0,1] ⊓ A.1 ⊓ D.0 ⊓ E.0 ⊓ ND2.0), 1 ↦ (([0,1] ⊓ A.1 ⊓ D.0 ⊓ E.0 ⊓ ND2.1) ⊔ ([0,1] ⊓ A.1 ⊓ D.1 ⊓ E.2 ⊓ ND2.1))}
  ND3: {0 ↦ (([0,1] ⊓ ND3.0 ⊓ X2.0) ⊔ ([1,0] ⊓ ND3.0 ⊓ U1.0 ⊓ U2.0 ⊓ U3.0) ⊔ ([0,1] ⊓ A.0 ⊓ B.0 ⊓ C.0 ⊓ ND3.0 ⊓ U1.1 ⊓ U3.1)), 1 ↦ (([0,1] ⊓ ND3.1 ⊓ X2.0) ⊔ ([0,1] ⊓ A.1 ⊓ C.1 ⊓ ND3.1 ⊓ X2.1) ⊔ ([1,0] ⊓ ND3.1 ⊓ U1.0 ⊓ U2.0 ⊓ U3.0) ⊔ ([0,1] ⊓ A.0 ⊓ B.0 ⊓ C.0 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ A.0 ⊓ B.1 ⊓ C.0 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ A.0 ⊓ B.1 ⊓ C.1 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ A.1 ⊓ B.1 ⊓ C.1 ⊓ ND3.1 ⊓ U1.1 ⊓ U3.1)), 2 ↦ (([0,1] ⊓ ND3.2 ⊓ X2.0) ⊔ ([1,0] ⊓ ND3.2 ⊓ U1.0 ⊓ U2.0 ⊓ U3.0) ⊔ ([1,0] ⊓ D.1 ⊓ ND3.2 ⊓ U1.0 ⊓ U2.0 ⊓ U3.2) ⊔ ([1,0] ⊓ D.1 ⊓ ND3.2 ⊓ U1.2 ⊓ U2.0 ⊓ U3.2) ⊔ ([1,0] ⊓ D.1 ⊓ ND3.2 ⊓ U1.2 ⊓ U2.1 ⊓ U3.2) ⊔ ([0,1] ⊓ A.0 ⊓ B.0 ⊓ C.0 ⊓ ND3.2 ⊓ U1.1 ⊓ U3.1))}
  ...
  RecNest2: {0 ↦ (([0,1] ⊓ RecNest1.0 ⊓ RecNest2.0) ⊔ ([0,1] ⊓ D.0 ⊓ E.0 ⊓ RecNest1.1 ⊓ RecNest2.0)), 1 ↦ (([0,1] ⊓ A.0 ⊓ C.0 ⊓ RecNest1.0 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.0 ⊓ E.0 ⊓ RecNest1.1 ⊓ RecNest2.1) ⊔ ([0,1] ⊓ D.1 ⊓ E.2 ⊓ RecNest1.1 ⊓ RecNest2.1))}
  MixNest: {0 ↦ (([1,0] ⊓ MixNest.0 ⊓ U1.0 ⊓ U2.0 ⊓ U3.0) ⊔ ([0,1] ⊓ A.0 ⊓ B.0 ⊓ C.0 ⊓ MixNest.0 ⊓ U1.1 ⊓ U3.1)), 1 ↦ (([1,0] ⊓ MixNest.1 ⊓ U1.0 ⊓ U2.0 ⊓ U3.0) ⊔ ([0,1] ⊓ A.0 ⊓ B.0 ⊓ C.0 ⊓ MixNest.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ A.0 ⊓ B.1 ⊓ C.0 ⊓ MixNest.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ A.0 ⊓ B.1 ⊓ C.1 ⊓ MixNest.1 ⊓ U1.1 ⊓ U3.1) ⊔ ([0,1] ⊓ A.1 ⊓ B.1 ⊓ C.1 ⊓ MixNest.1 ⊓ U1.1 ⊓ U3.1)), 2 ↦ (([1,0] ⊓ MixNest.2 ⊓ U1.0 ⊓ U2.0 ⊓ U3.0) ⊔ ([1,0] ⊓ D.1 ⊓ MixNest.2 ⊓ U1.0 ⊓ U2.0 ⊓ U3.2) ⊔ ([1,0] ⊓ D.1 ⊓ MixNest.2 ⊓ U1.2 ⊓ U2.0 ⊓ U3.2) ⊔ ([1,0] ⊓ D.1 ⊓ MixNest.2 ⊓ U1.2 ⊓ U2.1 ⊓ U3.2) ⊔ ([0,1] ⊓ A.0 ⊓ B.0 ⊓ C.0 ⊓ MixNest.2 ⊓ U1.1 ⊓ U3.1))}
  A0: {0 ↦ ([1,0] ⊓ A0.0 ⊓ B0.0)}
  B0: {0 ↦ ([1,0] ⊓ A0.0 ⊓ B0.0)}
  Z3: {0 ↦ ([0,1] ⊓ Z3.0), 1 ↦ ([0,1] ⊓ Z3.1), 2 ↦ (([1,0] ⊓ Z3.2) ⊔ ([0,1] ⊓ Z3.1 ⊓ Z3.2 ⊓ Z3.3)), 3 ↦ ([0,1] ⊓ Z3.1 ⊓ Z3.3)}
  ...
  PRE: {0 ↦ (([0,1] ⊓ PRC.0 ⊓ PRD.0 ⊓ PRE.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRC.0 ⊓ PRD.0 ⊓ PRE.0 ⊓ PRF.1) ⊔ ([0,1] ⊓ PRC.0 ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRC.0 ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.1) ⊔ ([0,1] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.0) ⊔ ([0,1] ⊓ PRC.1 ⊓ PRD.1 ⊓ PRE.0 ⊓ PRF.1)), 1 ↦ PRE.1}
  PRC: {0 ↦ ⊥, 1 ↦ ([0,1] ⊓ PRC.1)}
  PRD: {0 ↦ ⊥, 1 ↦ ([0,1] ⊓ PRC.1 ⊓ PRD.1)}
  PRG: {0 ↦ ⊥, 1 ↦ PRG.1, 2 ↦ ⊥}
  PRH: {0 ↦ ([0,1] ⊓ PRG.1 ⊓ PRH.0), 1 ↦ ([0,1] ⊓ PRG.1 ⊓ PRH.1), 2 ↦ PRH.2}
...
CN2: ceil={0 ↦ [0,1], 1 ↦ [2,0], 2 ↦ ⊥}, floor={0 ↦ [0,1], 1 ↦ ⊥, 2 ↦ ⊥}
...
Infer2: RHS as polys:
list: 'a1
rose: (list.0 ⊔ ('a1 ⊓ list.1) ⊔ (list.1 ⊓ rose.0))
lily: (list.0 ⊔ (list.1 ⊓ lily.0) ⊔ ('a1 ⊓ list.1 ⊓ lily.1))

Infer2: linear decomposition (base + coeffs):
list: base=⊥, 'a1=⊤
rose: base=(list.0 ⊔ (list.1 ⊓ rose.0)), 'a1=list.1
lily: base=(list.0 ⊔ (list.1 ⊓ lily.0)), 'a1=(list.1 ⊓ lily.1)
...
Ceil/Floor kinds:
list: ceil={0 ↦ [0,1], 1 ↦ [2,0]}, floor={0 ↦ ⊥, 1 ↦ ⊥}
rose: ceil={0 ↦ [0,1], 1 ↦ [2,0]}, floor={0 ↦ ⊥, 1 ↦ ⊥}
lily: ceil={0 ↦ [0,1], 1 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥}
...
[lfp] iter 1:
  H: {0 ↦ (F.0 ⊓ H.0), 1 ↦ H.1}
  F: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ (([0,1] ⊓ F.1 ⊓ H.0) ⊔ ([0,1] ⊓ F.1 ⊓ H.1))}
  H2: {0 ↦ (F2.0 ⊓ H2.0), 1 ↦ H2.1, 2 ↦ ((F2.0 ⊓ H2.2) ⊔ (F2.1 ⊓ H2.2))}
  F2: {0 ↦ ([0,1] ⊓ F2.0 ⊓ H2.0), 1 ↦ (([0,1] ⊓ F2.1 ⊓ H2.0) ⊔ ([0,1] ⊓ F2.1 ⊓ H2.1)), 2 ↦ (([1,0] ⊓ F2.2) ⊔ ([0,1] ⊓ F2.2 ⊓ H2.0) ⊔ ([0,1] ⊓ F2.2 ⊓ H2.2))}
  X: {0 ↦ ([0,1] ⊓ X.0 ⊓ Z.0), 1 ↦ (([0,1] ⊓ X.1 ⊓ Z.0) ⊔ ([0,1] ⊓ X.1 ⊓ Z.1))}
  Y: {0 ↦ (X.0 ⊓ Y.0), 1 ↦ Y.1}
  Z: {0 ↦ ([0,1] ⊓ Y.0 ⊓ Z.0), 1 ↦ (([0,1] ⊓ Y.0 ⊓ Z.1) ⊔ ([0,1] ⊓ Y.1 ⊓ Z.1))}
  P: {0 ↦ ([1,1] ⊓ P.0 ⊓ Q.0), 1 ↦ (([1,1] ⊓ P.1 ⊓ Q.0) ⊔ ([1,1] ⊓ P.1 ⊓ Q.1)), 2 ↦ (([0,1] ⊓ P.2) ⊔ ([1,0] ⊓ P.2 ⊓ Q.0))}
  Q: {0 ↦ ([1,0] ⊓ P.0 ⊓ Q.0), 1 ↦ Q.1}
  M: {0 ↦ ([0,1] ⊓ M.0), 1 ↦ M.1}
  U: {0 ↦ ((U.0 ⊓ V.0) ⊔ (U.0 ⊓ W.0)), 1 ↦ ((U.1 ⊓ V.0) ⊔ (U.1 ⊓ V.1) ⊔ (U.1 ⊓ W.0)), 2 ↦ ((U.2 ⊓ V.0) ⊔ (U.2 ⊓ W.0) ⊔ (U.2 ⊓ W.1))}
  V: {0 ↦ ([1,0] ⊓ U.0 ⊓ V.0), 1 ↦ (([1,0] ⊓ U.0 ⊓ V.1) ⊔ ([1,0] ⊓ U.1 ⊓ V.1) ⊔ ([1,0] ⊓ U.2 ⊓ V.1))}
  W: {0 ↦ ([0,1] ⊓ U.0 ⊓ W.0), 1 ↦ (([0,1] ⊓ U.0 ⊓ W.1) ⊔ ([0,1] ⊓ U.1 ⊓ W.1) ⊔ ([0,1] ⊓ U.2 ⊓ W.1))}
[lfp] iter 2:
  H: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ H.1}
  F: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ ([0,1] ⊓ F.1 ⊓ H.1)}
  H2: {0 ↦ ([0,1] ⊓ F2.0 ⊓ H2.0), 1 ↦ H2.1, 2 ↦ (([0,1] ⊓ F2.1 ⊓ H2.0 ⊓ H2.2) ⊔ ([0,1] ⊓ F2.1 ⊓ H2.1 ⊓ H2.2))}
  F2: {0 ↦ ([0,1] ⊓ F2.0 ⊓ H2.0), 1 ↦ ([0,1] ⊓ F2.1 ⊓ H2.1), 2 ↦ (([1,0] ⊓ F2.2) ⊔ ([0,1] ⊓ F2.0 ⊓ F2.2 ⊓ H2.2) ⊔ ([0,1] ⊓ F2.1 ⊓ F2.2 ⊓ H2.2))}
  X: {0 ↦ ([0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.0), 1 ↦ (([0,1] ⊓ X.1 ⊓ Y.0 ⊓ Z.0) ⊔ ([0,1] ⊓ X.1 ⊓ Y.0 ⊓ Z.1) ⊔ ([0,1] ⊓ X.1 ⊓ Y.1 ⊓ Z.1))}
  Y: {0 ↦ ([0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.0), 1 ↦ Y.1}
  Z: {0 ↦ ([0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.0), 1 ↦ (([0,1] ⊓ Y.1 ⊓ Z.1) ⊔ ([0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.1))}
  P: {0 ↦ ([1,0] ⊓ P.0 ⊓ Q.0), 1 ↦ ([1,1] ⊓ P.1 ⊓ Q.1), 2 ↦ ([0,1] ⊓ P.2)}
  Q: {0 ↦ ([1,0] ⊓ P.0 ⊓ Q.0), 1 ↦ Q.1}
  M: {0 ↦ ([0,1] ⊓ M.0), 1 ↦ M.1}
  U: {0 ↦ (([1,0] ⊓ U.0 ⊓ V.0) ⊔ ([0,1] ⊓ U.0 ⊓ W.0)), 1 ↦ ([1,0] ⊓ U.1 ⊓ V.1), 2 ↦ ([0,1] ⊓ U.2 ⊓ W.1)}
  V: {0 ↦ ([1,0] ⊓ U.0 ⊓ V.0), 1 ↦ (([1,0] ⊓ U.1 ⊓ V.1) ⊔ ([1,0] ⊓ U.0 ⊓ V.1 ⊓ W.0) ⊔ ([1,0] ⊓ U.2 ⊓ V.0 ⊓ V.1) ⊔ ([1,0] ⊓ U.2 ⊓ V.1 ⊓ W.0) ⊔ ([1,0] ⊓ U.2 ⊓ V.1 ⊓ W.1))}
  W: {0 ↦ ([0,1] ⊓ U.0 ⊓ W.0), 1 ↦ (([0,1] ⊓ U.2 ⊓ W.1) ⊔ ([0,1] ⊓ U.0 ⊓ V.0 ⊓ W.1) ⊔ ([0,1] ⊓ U.1 ⊓ V.0 ⊓ W.1) ⊔ ([0,1] ⊓ U.1 ⊓ V.1 ⊓ W.1) ⊔ ([0,1] ⊓ U.1 ⊓ W.0 ⊓ W.1))}
[lfp] iter 3:
  H: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ H.1}
  F: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ ([0,1] ⊓ F.1 ⊓ H.1)}
  H2: {0 ↦ ([0,1] ⊓ F2.0 ⊓ H2.0), 1 ↦ H2.1, 2 ↦ ([0,1] ⊓ F2.1 ⊓ H2.1 ⊓ H2.2)}
  F2: {0 ↦ ([0,1] ⊓ F2.0 ⊓ H2.0), 1 ↦ ([0,1] ⊓ F2.1 ⊓ H2.1), 2 ↦ (([1,0] ⊓ F2.2) ⊔ ([0,1] ⊓ F2.1 ⊓ F2.2 ⊓ H2.0 ⊓ H2.2) ⊔ ([0,1] ⊓ F2.1 ⊓ F2.2 ⊓ H2.1 ⊓ H2.2))}
  X: {0 ↦ ([0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.0), 1 ↦ (([0,1] ⊓ X.1 ⊓ Y.1 ⊓ Z.1) ⊔ ([0,1] ⊓ X.0 ⊓ X.1 ⊓ Y.0 ⊓ Z.1))}
  Y: {0 ↦ ([0,1] ⊓ X.0 ⊓ Y.0 ⊓ Z.0), 1 ↦ Y.1}
