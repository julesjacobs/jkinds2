...
Generated: 2025-08-22 19:33:57 UTC
...
M1: ([1,0] ⊔ M2.0 ⊔ ('a1 ⊓ M2.1))
M2: ([0,1] ⊔ ([2,0] ⊓ 'a1))
AC: (([1,0] ⊓ M2.0) ⊔ ([0,1] ⊓ M1.0) ⊔ ([1,0] ⊓ 'a1 ⊓ M2.1) ⊔ ([0,1] ⊓ 'a1 ⊓ M1.1))
PH: 'a1
X1: ('a1 ⊔ X2.0)
X2: (([0,1] ⊓ X1.0) ⊔ ([0,1] ⊓ 'a1 ⊓ X1.1))
S: (([0,1] ⊓ U.0) ⊔ ([1,0] ⊓ T.0) ⊔ ([0,1] ⊓ 'a1 ⊓ U.1) ⊔ ([1,0] ⊓ 'a1 ⊓ T.1))
T: (S.0 ⊔ ('a1 ⊓ S.1))
U: (([0,1] ⊓ S.0) ⊔ ([0,1] ⊓ 'a1 ⊓ S.1))
Z1: (([1,0] ⊓ 'a1) ⊔ ([1,0] ⊓ 'a2) ⊔ ([0,1] ⊓ Z1.0) ⊔ ([0,1] ⊓ 'a1 ⊓ Z1.1) ⊔ ([0,1] ⊓ 'a2 ⊓ Z1.2))
DUP: ([1,1] ⊔ ([2,0] ⊓ 'a1))
SW: (([1,1] ⊓ DUP.0) ⊔ ([1,0] ⊓ 'a1 ⊓ DUP.1) ⊔ ([0,1] ⊓ 'a2 ⊓ DUP.1))
ND1: ('a1 ⊔ C.0 ⊔ (C.1 ⊓ D.0))
...
M2: base=[0,1], 'a1=[2,0]
AC: base=(([1,0] ⊓ M2.0) ⊔ ([0,1] ⊓ M1.0)), 'a1=(([1,0] ⊓ M2.1) ⊔ ([0,1] ⊓ M1.1))
PH: base=⊥, 'a1=⊤, 'a2=⊥
X1: base=X2.0, 'a1=⊤
X2: base=([0,1] ⊓ X1.0), 'a1=([0,1] ⊓ X1.1)
S: base=(([0,1] ⊓ U.0) ⊔ ([1,0] ⊓ T.0)), 'a1=(([0,1] ⊓ U.1) ⊔ ([1,0] ⊓ T.1))
T: base=S.0, 'a1=S.1
U: base=([0,1] ⊓ S.0), 'a1=([0,1] ⊓ S.1)
Z1: base=([0,1] ⊓ Z1.0), 'a1=([1,0] ⊔ ([0,1] ⊓ Z1.1)), 'a2=([1,0] ⊔ ([0,1] ⊓ Z1.2))
DUP: base=[1,1], 'a1=[2,0]
SW: base=([1,1] ⊓ DUP.0), 'a1=([1,0] ⊓ DUP.1), 'a2=([0,1] ⊓ DUP.1)
...
X2.0 ≤ ([0,1] ⊓ X2.0)
X2.1 ≤ ([0,1] ⊓ X2.1)
S.0 ≤ (([0,1] ⊓ U.0 ⊓ S.0) ⊔ ([1,0] ⊓ T.0 ⊓ S.0))
S.1 ≤ (([0,1] ⊓ U.1 ⊓ S.1) ⊔ ([1,0] ⊓ T.1 ⊓ S.1) ⊔ ([0,1] ⊓ U.0 ⊓ S.0 ⊓ S.1) ⊔ ([1,0] ⊓ T.0 ⊓ S.0 ⊓ S.1))
T.0 ≤ (([1,0] ⊓ T.0 ⊓ S.0) ⊔ ([0,1] ⊓ U.0 ⊓ T.0 ⊓ S.0))
T.1 ≤ (([1,0] ⊓ T.1 ⊓ S.1) ⊔ ([0,1] ⊓ U.0 ⊓ T.1 ⊓ S.0) ⊔ ([0,1] ⊓ U.1 ⊓ T.1 ⊓ S.1) ⊔ ([1,0] ⊓ T.0 ⊓ T.1 ⊓ S.0))
U.0 ≤ ([0,1] ⊓ U.0 ⊓ S.0)
...
NestSTU.0 ≤ (([1,0] ⊓ T.0 ⊓ S.0 ⊓ NestSTU.0) ⊔ ([0,1] ⊓ U.0 ⊓ T.0 ⊓ S.0 ⊓ NestSTU.0) ⊔ ([0,1] ⊓ U.0 ⊓ T.1 ⊓ S.0 ⊓ NestSTU.0))
NestSTU.1 ≤ (([1,0] ⊓ T.0 ⊓ S.0 ⊓ NestSTU.1) ⊔ ([0,1] ⊓ U.0 ⊓ T.0 ⊓ S.0 ⊓ NestSTU.1) ⊔ ([0,1] ⊓ U.0 ⊓ T.1 ⊓ S.0 ⊓ NestSTU.1) ⊔ ([0,1] ⊓ U.1 ⊓ T.1 ⊓ S.1 ⊓ NestSTU.1))
AnnNest.0 ≤ ⊥
...
MixNest.0 ≤ ⊥
MixNest.1 ≤ (([1,0] ⊓ C.1 ⊓ A.1 ⊓ Z1.1 ⊓ MixNest.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.1 ⊓ A.1 ⊓ U3.1 ⊓ U1.1 ⊓ MixNest.1))
MixNest.2 ≤ ([1,0] ⊓ Z1.2 ⊓ MixNest.2)
A0.0 ≤ ([1,0] ⊓ B0.0 ⊓ A0.0)
B0.0 ≤ ([1,0] ⊓ B0.0 ⊓ A0.0)
Z3.0 ≤ ([0,1] ⊓ Z3.0)
Z3.1 ≤ ([0,1] ⊓ Z3.1)
...
DupSelf.0 ≤ (([0,1] ⊓ U.0 ⊓ S.0 ⊓ DupSelf.0) ⊔ ([1,0] ⊓ T.0 ⊓ S.0 ⊓ DupSelf.0))
DupSelf.1 ≤ (([0,1] ⊓ U.0 ⊓ S.0 ⊓ DupSelf.1) ⊔ ([0,1] ⊓ U.1 ⊓ S.1 ⊓ DupSelf.1) ⊔ ([1,0] ⊓ T.0 ⊓ S.0 ⊓ DupSelf.1) ⊔ ([1,0] ⊓ T.1 ⊓ S.1 ⊓ DupSelf.1))
...
S: {0 ↦ (([0,1] ⊓ U.0 ⊓ S.0) ⊔ ([1,0] ⊓ T.0 ⊓ S.0)), 1 ↦ (([0,1] ⊓ U.1 ⊓ S.1) ⊔ ([1,0] ⊓ T.1 ⊓ S.1))}
T: {0 ↦ (([1,0] ⊓ T.0 ⊓ S.0) ⊔ ([0,1] ⊓ U.0 ⊓ T.0 ⊓ S.0)), 1 ↦ (([1,0] ⊓ T.1 ⊓ S.1) ⊔ ([0,1] ⊓ U.0 ⊓ T.1 ⊓ S.0) ⊔ ([0,1] ⊓ U.1 ⊓ T.1 ⊓ S.1))}
...
NestSTU: {0 ↦ (([1,0] ⊓ T.0 ⊓ S.0 ⊓ NestSTU.0) ⊔ ([0,1] ⊓ U.0 ⊓ T.0 ⊓ S.0 ⊓ NestSTU.0) ⊔ ([0,1] ⊓ U.0 ⊓ T.1 ⊓ S.0 ⊓ NestSTU.0)), 1 ↦ (([1,0] ⊓ T.0 ⊓ S.0 ⊓ NestSTU.1) ⊔ ([0,1] ⊓ U.0 ⊓ T.0 ⊓ S.0 ⊓ NestSTU.1) ⊔ ([0,1] ⊓ U.0 ⊓ T.1 ⊓ S.0 ⊓ NestSTU.1) ⊔ ([0,1] ⊓ U.1 ⊓ T.1 ⊓ S.1 ⊓ NestSTU.1))}
...
MixNest: {0 ↦ ⊥, 1 ↦ (([1,0] ⊓ C.1 ⊓ A.1 ⊓ Z1.1 ⊓ MixNest.1) ⊔ ([0,1] ⊓ B.1 ⊓ C.1 ⊓ A.1 ⊓ U3.1 ⊓ U1.1 ⊓ MixNest.1)), 2 ↦ ([1,0] ⊓ Z1.2 ⊓ MixNest.2)}
A0: {0 ↦ ([1,0] ⊓ B0.0 ⊓ A0.0)}
B0: {0 ↦ ([1,0] ⊓ B0.0 ⊓ A0.0)}
...
DupSelf: {0 ↦ (([0,1] ⊓ U.0 ⊓ S.0 ⊓ DupSelf.0) ⊔ ([1,0] ⊓ T.0 ⊓ S.0 ⊓ DupSelf.0)), 1 ↦ (([0,1] ⊓ U.0 ⊓ S.0 ⊓ DupSelf.1) ⊔ ([0,1] ⊓ U.1 ⊓ S.1 ⊓ DupSelf.1) ⊔ ([1,0] ⊓ T.0 ⊓ S.0 ⊓ DupSelf.1) ⊔ ([1,0] ⊓ T.1 ⊓ S.1 ⊓ DupSelf.1))}
...
AC: ceil={0 ↦ [0,1], 1 ↦ [1,0]}, floor={0 ↦ ⊥, 1 ↦ ⊥}
PH: ceil={0 ↦ ⊥, 1 ↦ ⊤, 2 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥, 2 ↦ ⊥}
X1: ceil={0 ↦ [0,1], 1 ↦ [2,0]}, floor={0 ↦ ⊥, 1 ↦ ⊤}
X2: ceil={0 ↦ [0,1], 1 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥}
S: ceil={0 ↦ [1,1], 1 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥}
T: ceil={0 ↦ [1,1], 1 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥}
U: ceil={0 ↦ [0,1], 1 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥}
Z1: ceil={0 ↦ [0,1], 1 ↦ [1,0], 2 ↦ [1,0]}, floor={0 ↦ ⊥, 1 ↦ ⊥, 2 ↦ ⊥}
DUP: ceil={0 ↦ [1,1], 1 ↦ [2,0]}, floor={0 ↦ [1,1], 1 ↦ [2,0]}
SW: ceil={0 ↦ [1,1], 1 ↦ ⊥, 2 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥, 2 ↦ ⊥}
...
X: (([0,1] ⊓ Z.0) ⊔ ([1,0] ⊓ Y.0) ⊔ ([0,1] ⊓ 'a1 ⊓ Z.1) ⊔ ([1,0] ⊓ 'a1 ⊓ Y.1))
Y: ('a1 ⊔ X.0)
...
X: base=(([0,1] ⊓ Z.0) ⊔ ([1,0] ⊓ Y.0)), 'a1=(([0,1] ⊓ Z.1) ⊔ ([1,0] ⊓ Y.1))
Y: base=X.0, 'a1=⊤
...
X.0 ≤ (([1,0] ⊓ Y.0 ⊓ X.0) ⊔ ([0,1] ⊓ Z.0 ⊓ Y.0 ⊓ X.0))
X.1 ≤ (([1,0] ⊓ Y.1 ⊓ X.1) ⊔ ([0,1] ⊓ Z.1 ⊓ Y.1 ⊓ X.1) ⊔ ([1,0] ⊓ Y.0 ⊓ X.0 ⊓ X.1) ⊔ ([0,1] ⊓ Z.0 ⊓ Y.0 ⊓ X.0 ⊓ X.1))
Y.0 ≤ (([1,0] ⊓ Y.0 ⊓ X.0) ⊔ ([0,1] ⊓ Z.0 ⊓ Y.0 ⊓ X.0))
Y.1 ≤ Y.1
Z.0 ≤ ([0,1] ⊓ Z.0 ⊓ Y.0 ⊓ X.0)
...
C1.1 = ⊤
C2.0 = ([0,1] ⊓ F.0 ⊓ H.0)
C2.1 = ([1,0] ⊔ ([0,1] ⊓ F.1 ⊓ H.1) ⊔ ([0,1] ⊓ F.0 ⊓ F.1 ⊓ H.0))
...
X: {0 ↦ (([1,0] ⊓ Y.0 ⊓ X.0) ⊔ ([0,1] ⊓ Z.0 ⊓ Y.0 ⊓ X.0)), 1 ↦ (([1,0] ⊓ Y.1 ⊓ X.1) ⊔ ([0,1] ⊓ Z.1 ⊓ Y.1 ⊓ X.1))}
Y: {0 ↦ (([1,0] ⊓ Y.0 ⊓ X.0) ⊔ ([0,1] ⊓ Z.0 ⊓ Y.0 ⊓ X.0)), 1 ↦ Y.1}
...
C1: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ ⊤}
C2: {0 ↦ ([0,1] ⊓ F.0 ⊓ H.0), 1 ↦ ([1,0] ⊔ ([0,1] ⊓ F.1 ⊓ H.1) ⊔ ([0,1] ⊓ F.0 ⊓ F.1 ⊓ H.0))}
...
X: ceil={0 ↦ [1,1], 1 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥}
Y: ceil={0 ↦ [1,1], 1 ↦ [2,0]}, floor={0 ↦ ⊥, 1 ↦ ⊥}
...
C2: ceil={0 ↦ [0,1], 1 ↦ [1,0]}, floor={0 ↦ ⊥, 1 ↦ [1,0]}
...
two_axes: (([0,1] ⊓ G.0) ⊔ ([1,0] ⊓ F.0) ⊔ ([0,1] ⊓ 'a1 ⊓ G.1) ⊔ ([1,0] ⊓ 'a1 ⊓ F.1))
...
two_axes: base=(([0,1] ⊓ G.0) ⊔ ([1,0] ⊓ F.0)), 'a1=(([0,1] ⊓ G.1) ⊔ ([1,0] ⊓ F.1))
...
list_ann.0 = ⊥
list_ann.1 = [1,0]
two_axes.0 = (([0,1] ⊓ G.0) ⊔ ([1,0] ⊓ F.0))
two_axes.1 = (([0,1] ⊓ G.1) ⊔ ([1,0] ⊓ F.1))
...
two_axes: ceil={0 ↦ [1,1], 1 ↦ ⊥}, floor={0 ↦ ⊥, 1 ↦ ⊥}
