...
Generated: 2025-08-25 18:11:31 UTC
...
one: {0 ↦ [0,1] ⊓ one.0}
two: {0 ↦ [0,1] ⊓ one.0}
maybe: {0 ↦ (maybe.0 ⊓ some.0) ⊔ (maybe.0 ⊓ none.0), 1 ↦ (maybe.1 ⊓ some.0) ⊔ (maybe.1 ⊓ some.1) ⊔ (maybe.1 ⊓ none.0)}
wrap: {0 ↦ ⊥, 1 ↦ [1,0] ⊓ wrap.1}
wrap2: {0 ↦ wrap2.0, 1 ↦ wrap2.1}
pairish: {0 ↦ ⊥, 1 ↦ [1,0] ⊓ pairish.1, 2 ↦ [1,0] ⊓ pairish.2}
treeA: {0 ↦ (node.0 ⊓ treeA.0) ⊔ (node.2 ⊓ treeA.0) ⊔ (leaf.0 ⊓ treeA.0), 1 ↦ (node.0 ⊓ treeA.1) ⊔ (node.1 ⊓ treeA.1) ⊔ (node.2 ⊓ treeA.1) ⊔ (leaf.0 ⊓ treeA.1)}
H: {0 ↦ [0,1] ⊓ F.0 ⊓ H.0, 1 ↦ H.1}
F: {0 ↦ [0,1] ⊓ F.0 ⊓ H.0, 1 ↦ [0,1] ⊓ F.1 ⊓ H.1}
G: {0 ↦ ⊤, 1 ↦ ⊥}
```
